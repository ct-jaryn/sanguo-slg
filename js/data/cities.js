function makeCities() {
  ...
  const data = [
    ...
    {name:'长安',owner:'cao',troops:2000,defense:1.3,food:90,money:100,morale:75,neighbors:['洛阳','弘农','天水','汉中','武关','安定'],region:'北方',x:860,y:900,traits:['capital','fortress']},
    {name:'武关',owner:null,troops:1200,defense:1.0,food:60,money:50,morale:55,neighbors:['弘农','长安','上庸','襄阳','荆州'],region:'北方',x:980,y:1060,traits:['fortress','strategic']},
    // 中原 (Central)
    ...
    {name:'寿春',owner:null,troops:1800,defense:1.1,food:110,money:100,morale:70,neighbors:['徐州','下邳','广陵','扬州','汝南'],region:'中原',x:1660,y:1040,traits:['strategic','military']},
    {name:'汝南',owner:null,troops:1500,defense:1.0,food:90,money:80,morale:70,neighbors:['寿春','江夏','襄阳'],region:'中原',x:1480,y:1000,traits:['granary']},
    // 南方 (South)
    ...
    {name:'江夏',owner:'sun',troops:1600,defense:1.0,food:110,money:95,morale:70,neighbors:['汝南','扬州','柴桑','襄阳','长沙','荆州'],region:'南方',x:1420,y:1160,traits:['port','military']},
